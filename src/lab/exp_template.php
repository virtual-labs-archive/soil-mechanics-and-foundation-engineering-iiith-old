...
<head>
  ...
  page -->
  <link rel="shortcut icon" href="http://deploy.virtual-labs.ac.in/labs/eerc02/images/favicon.png"   class="custom">
...
<!-- The lab Header contains the logo and the name of the lab,
	...
	<div class="breadcrumb" id="experiment-article-breadcrumb"><a href="<?php echo $vlab_url?>">Home</a><a></a> &gt; <a href="<?php echo $lab_url?>">Soil Mechanics Lab</a>    </div>
	...
	<section id="experiment-article-section-1">
		...
		<!-- Enclose the icon image of your lab -->
		<img src="http://deploy.virtual-labs.ac.in/labs/eerc02/images/introduction.jpg">
		</div>	
  ...
  footer-->
   <footer id="lab-footer" class="footer">
	...
	<a href="http://virtual-labs.ac.in/nmeict/">Sponsered by MHRD (NME-ICT) </a> | <a href="http://virtual-labs.ac.in/licensing/" target="_blank"> Licensing Terms </a> | <a href="http://virtual-labs.ac.in/feedback/?lab=eerc02/" target="_blank"> Feedback </a>
  </footer>
