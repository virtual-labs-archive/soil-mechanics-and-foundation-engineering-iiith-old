...
$css_js   = "http://deploy.virtual-labs.ac.in/labs/eerc02/"; 
$lab_url  = "http://deploy.virtual-labs.ac.in/labs/eerc02/index.php";
$exp_url  =  "http://deploy.virtual-labs.ac.in/labs/eerc02/exp10/index.php";
$base_url = $exp_url;
