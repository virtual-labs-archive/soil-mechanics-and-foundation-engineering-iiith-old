...
function experimentSetup(x) {
  ...
  if (x.matches) { // If media query matches
    ...
    var measureJar = draw.rect(50, 80).stroke({
      width: 3
    }).fill('none').attr({
      x: 850,
      y: 500
    ...
    text.move(740, 30).font({
      fill: '#f06',
      family: 'Inconsolata',
    })

    var text = draw.text('Supply')
    text.move(760, 80).font({
      fill: '#f06',
      family: 'Inconsolata',
    })

    var text = draw.text('Overflow')
    text.move(760, 145).font({
      fill: '#f06',
      family: 'Inconsolata',
    })

    var text = draw.text('h')
    text.move(520, 200).font({
      fill: '#f06',
      family: 'Inconsolata'
    })
    ...
    text.move(600, 555).font({
      fill: '#f06',
      family: 'Inconsolata',
    })

    var text = draw.text('Measuring Jar')
    text.move(910, 555).font({
      fill: '#f06',
      family: 'Inconsolata',
    })
  }
