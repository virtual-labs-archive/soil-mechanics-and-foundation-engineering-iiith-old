  ...
  private static class MyFrame extends JFrame {
      /**
		...
		MyFrame() {
          ...
          setTitle("Consolidation Test Applet");
...
////      rightBottom.setBackground(new Color(100,200,100));
  ...
  private void centerPanel(Container container){
       ...
       JLabel lbl = new JLabel("Consolidation Test ", JLabel.CENTER);
...
//  }
  ...
  public int getStr() {
	...
	private void initInputControlsField() {
		...
		iLabel[i++].setForeground(Color.blue);// new JLabel(":Consolidation (Hinge)",
												// JLabel.LEFT);
