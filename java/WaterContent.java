...
public class WaterContent extends javax.swing.JPanel {
	/**
	 * 
	 */
...
//		 Floor
	...
	private Group createVirtualLab() {	
	 ...
	 // Load and Spring Part :
      ...
      objtrans.addChild(m_j3d.createBox(new Vector3d(.25f,-.11,.8),new Vector3d(0.05f, .005f, 0.05f),new Vector3d(2f, 0f,0f), new Color3f(.85f, 0.64f, .125f)));
	    ...
	    //base(weight)
	    obj1.addChild(createWireBox(new Vector3d(0,-.08f,.8),new Vector3d(0.2/4f, .03/4f, 0.2/4f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(160,82,45)));
   ...
   */
  public WaterContent(Container container) {
...
//      scene.addChild(bgleg);
  ...
  public static class MyApplet extends JApplet {
      /**
		 ...
		 */
		private static final long serialVersionUID = 1L;
		WaterContent mainPanel;

      public void init() {
          setLayout(new BorderLayout());
          mainPanel = new WaterContent(this);
  ...
  private static class MyFrame extends JFrame {
      /**
		...
		MyFrame() {
          ...
          getContentPane().add(new WaterContent(this), BorderLayout.CENTER);
          pack();
      }
  }
...
////      rightBottom.setBackground(new Color(100,200,100));
  ...
  private void centerPanel(Container container){
       ...
       JLabel lbl = new JLabel("Water Content In Soil ", JLabel.CENTER);
