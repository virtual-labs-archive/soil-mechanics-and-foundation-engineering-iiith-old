...
public class AttenbergLimits extends javax.swing.JPanel {
	/**
	 * 
	 */
...
//		 Floor
   ...
   */
  public AttenbergLimits(Container container) {
...
//      scene.addChild(bgleg);
  ...
  public static class MyApplet extends JApplet {
      /**
		 ...
		 */
		private static final long serialVersionUID = 1L;
		AttenbergLimits mainPanel;

      public void init() {
          setLayout(new BorderLayout());
          mainPanel = new AttenbergLimits(this);
  ...
  private static class MyFrame extends JFrame {
      /**
		...
		MyFrame() {
          ...
          getContentPane().add(new AttenbergLimits(this), BorderLayout.CENTER);
          pack();
      }
  }
...
//  }
  ...
  public int getStr() {
	...
	private void initInputControlsField() {
		...
		iLabel[i++].setForeground(Color.blue);// new JLabel(":AttenbergLimits (Hinge)",
												// JLabel.LEFT);
