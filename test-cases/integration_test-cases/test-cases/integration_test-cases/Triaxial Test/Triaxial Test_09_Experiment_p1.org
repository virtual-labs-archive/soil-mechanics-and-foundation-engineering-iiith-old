...
* Objective
  - To view the Experiment of the "Triaxial Test" experiment
...
* Test Steps
  ...
  3. Click on the 'Go to Flash view on Triaxial Test' link present in the page
...
* Expected result
  ...
  4. The presentation about the Triaxial Test Experiment should start playing on then screen
