...
* Objective
  - To view the Experiment of the "Consolidation Test" experiment
...
* Test Steps
  ...
  3. Click on the 'Go to Flash view on Consolidation Test' link present in the page
...
* Expected result
  ...
  4. The presentation about the Consolidation Test experiment should start playing on then screen
