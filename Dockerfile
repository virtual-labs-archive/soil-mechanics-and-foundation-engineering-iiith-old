...
RUN mkdir /soil-mechanics-and-foundation-engineering-iiith

COPY src/ /soil-mechanics-and-foundation-engineering-iiith/src

WORKDIR ./soil-mechanics-and-foundation-engineering-iiith/src
